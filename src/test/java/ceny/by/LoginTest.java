...
import ru.sale.edc.LoginRequest;
...
public class LoginTest {
    ...
    public void test1() {
        given().
                body(ru.sale.edc.LoginRequest.getBodyRequestFull()).
                headers(ru.sale.edc.LoginRequest.getHeader()).
                when().
                post(ru.sale.edc.LoginRequest.URL_LOGIN).
                then().
                log().all().
    ...
    public void test3() {
        given().
                body(ru.sale.edc.LoginRequest.getBodyRequestNoEmail()).
                headers(ru.sale.edc.LoginRequest.getHeader()).
                when().
                post(ru.sale.edc.LoginRequest.URL_LOGIN).
                then().
    ...
    public void test4() {
        given().
                body(ru.sale.edc.LoginRequest.getBodyRequestNoPassword()).
                headers(ru.sale.edc.LoginRequest.getHeader()).
                when().
                post(ru.sale.edc.LoginRequest.URL_LOGIN).
                then().
    ...
    public void test5() {
        given().
                body(ru.sale.edc.LoginRequest.getBodyRequestInccorrectSymbols()).
                headers(ru.sale.edc.LoginRequest.getHeader()).
                when().
                post(ru.sale.edc.LoginRequest.URL_LOGIN).
                then().
    ...
    public void test6() {
        given().
                body(ru.sale.edc.LoginRequest.getBodyRequestFull()).
                headers(ru.sale.edc.LoginRequest.getHeaderForBadRequest()).
                when().
